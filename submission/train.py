...
model.add(Convolution2D(6,6,5, border_mode='same', subsample=(2, 2),activation='relu'))
...
# model launch
history = model.fit(x, y, epochs=5, verbose=1,  validation_split=0.2,  shuffle=True)
